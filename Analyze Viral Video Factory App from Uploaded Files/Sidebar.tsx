    ...
    <>
      <div className="flex items-center justify-between p-4 border-b border-gray-700">
          <div className="flex items-center gap-2">
            ...
            <span className="text-white text-lg font-bold">{config.headerTitle}</span>
          </div>
      ...
      <nav className="p-4 space-y-1.5 flex-1 overflow-y-auto">
        ...
        <NavLink page="product-ad-studio" icon={<ShoppingBagIcon className="w-5 h-5"/>}>{config.studioTitle}</NavLink>
