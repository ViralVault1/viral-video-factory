...
export const FilmIcon: React.FC<IconProps> = ({ className = "w-6 h-6" }) => (
  <svg className={className} fill="none" stroke="currentColor" viewBox="0 0 24 24">
    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M7 4V2a1 1 0 011-1h8a1 1 0 011 1v2m0 0V3a1 1 0 011 1v1M7 4V3a1 1 0 011-1v0a1 1 0 011 1v1m-4 0h12M5 8h14l-1 8H6L5 8z" />
  </svg>
);
...
export const ProductHuntIcon: React.FC<IconProps> = ({ className = "w-6 h-6" }) => (
  <svg className={className} fill="currentColor" viewBox="0 0 24 24">
    <path d="M13.604 9.72h-3.405V12h3.405c.995 0 1.275-.42 1.275-1.14s-.28-1.14-1.275-1.14zM12 0C5.372 0 0 5.372 0 12s5.372 12 12 12 12-5.372 12-12S18.628 0 12 0zm1.604 15.12h-3.405V18H7.801V6h5.803c2.319 0 3.717 1.44 3.717 3.6s-1.398 3.6-3.717 3.6v1.92z"/>
  </svg>
);
